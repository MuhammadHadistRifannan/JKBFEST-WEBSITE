...
<head>
    ...
    <style>
        ...
        .webdev-pad {
            padding-top: 15rem; /* Meningkat dari 10rem */
            padding-bottom: 15rem; /* Meningkat dari 12rem */
            background-size: cover; /* Pastikan cover menutup penuh */
        }
        
        .about-title { font-size: 38px; }
        .about-title span { font-size: 44px; }
        .about-circle-wrapper { width: 320px; height: 320px; }
        .hero-big-logo {
            width: 120% !important;
        ...
        @media (max-width: 991px) {
            ...
            .hero-pad { padding-top: 8rem; padding-bottom: 5rem; }
            ...
            .countdown-container { width: 100%; max-width: 350px; display: block; margin: 0 auto 30px auto; }
            .countdown-items { justify-content: center; }
            .hero-actions { justify-content: center; }
            
            .about-circle-wrapper { width: 250px; height: 250px; margin-bottom: 30px; }
            
            /* Web Dev Mobile adjustment */
            .webdev-pad { 
                padding-top: 10rem; /* Tetap besar di mobile */
        ...
        @media (max-width: 768px) {
            ...
            .about-title span { font-size: 32px; }
            .about-circle-wrapper { width: 200px; height: 200px; }
            
            .timeline-line::before { left: 20px; transform: none; }
            .timeline-row { flex-direction: column; margin-bottom: 30px !important; }
            .timeline-col {
                width: 100% !important;
            ...
            .timeline-card-wrapper { max-width: 100%; }
            .timeline-card-body { text-align: left !important; }
            .timeline-circle {
                left: 20px !important;
                top: 0 !important;
            ...
            #timeline::before { background-size: 90%; opacity: 0.1; }
...
<body>
    ...
    <nav class="navbar navbar-expand-lg position-absolute w-100 top-0 z-3 pt-4" data-aos="fade-down" data-aos-duration="1000">
        <div class="container">
    ...
    <section class="position-relative overflow-hidden" 
             style="background-image: url('{{ asset('images/background-hero.png') }}'); background-size: cover; background-position: center bottom; background-repeat: no-repeat;">
        <div class="container position-relative z-2 hero-pad">
            <div class="row align-items-center">
                
                <div class="col-lg-6 text-white text-center text-lg-start">
                    <p class="fw-semibold mb-2" style="font-size: 10px; letter-spacing: 1.5px;" data-aos="fade-right" data-aos-delay="200">COMPUTER AND BUSINESS DEPARTMENT PRESENT</p>
                    <h1 class="fw-bolder mb-3 hero-title" data-aos="fade-right" data-aos-delay="400">JKB Festival<br>2026</h1>
                    <p class="fs-5 fw-normal mb-4" data-aos="fade-right" data-aos-delay="600">JKB Innovate, Create, and Impact</p>

                    <div class="d-inline-block rounded-4 p-4 mb-4 text-start countdown-container" data-aos="fade-up" data-aos-delay="800">
                        ...
                        <div class="d-flex gap-3 gap-md-4 countdown-items">
                            <div class="text-center countdown-box">
                                <div class="fw-bold lh-1 countdown-number" style="font-size: 36px;" id="days">00</div>
                                <div class="fw-normal" style="font-size: 11px;">Hari</div>
                            </div>
                            <div class="text-center countdown-box">
                                <div class="fw-bold lh-1 countdown-number" style="font-size: 36px;" id="hours">00</div>
                                <div class="fw-normal" style="font-size: 11px;">Jam</div>
                            </div>
                            <div class="text-center countdown-box">
                                <div class="fw-bold lh-1 countdown-number" style="font-size: 36px;" id="minutes">00</div>
                                <div class="fw-normal" style="font-size: 11px;">Menit</div>
                            </div>
                            <div class="text-center countdown-box">
                                <div class="fw-bold lh-1 countdown-number" style="font-size: 36px;" id="seconds">00</div>
                                <div class="fw-normal" style="font-size: 11px;">Detik</div>
                            </div>
                        </div>
                    </div>

                    <div class="d-flex gap-3 justify-content-center justify-content-lg-start flex-wrap" data-aos="fade-up" data-aos-delay="1000">
                        <a href="{{ route('register.view') }}" class="btn bg-white rounded-pill px-4 py-3 fw-bold" style="color: #5b1456; font-size: 14px;">Daftar Sekarang</a>
                        <a href="#tentang" class="btn rounded-pill px-4 py-3 fw-semibold text-white" style="border: 1.5px solid white; font-size: 14px;">Pelajari lebih lanjut</a>
                    </div>
                </div>

                <div class="col-lg-6 text-center position-relative mt-5 mt-lg-0" style="z-index: 10;" data-aos="zoom-in" data-aos-duration="1500">
                    <img src="{{ asset('images/logo-besar.png') }}" class="img-fluid hero-big-logo" alt="JKB Fest Big Logo">
                </div>
            </div>
        </div>
    </section>

    <section id="tentang" class="position-relative z-1 py-5" style="background-color: #FFFFFF; background-image: radial-gradient(#e0e0e0 2px, transparent 2px); background-size: 30px 30px;">
        <div class="container py-5 my-md-5">
            <div class="row align-items-center g-5">
                
                <div class="col-lg-5 text-center" data-aos="fade-right" data-aos-duration="1000">
                    <div class="bg-white rounded-circle shadow-lg d-flex align-items-center justify-content-center mx-auto about-circle-wrapper">
                ...
                <div class="col-lg-7 text-center text-lg-start" data-aos="fade-left" data-aos-duration="1000">
                    <h2 class="fw-bolder mb-4 about-title" style="color: #5b1456;">Apa itu JKB FESTIVAL <span class="fw-bold">?</span></h2>
    ...
    <section id="asset" class="py-5 text-center" style="background-color: #FAFAFA;">
        <div class="container py-5">
            <div class="d-inline-block position-relative mb-5" data-aos="fade-up">
                ...
                <div class="position-absolute bottom-0 start-50 translate-middle-x" style="width: 80%; height: 4px; background: linear-gradient(135deg, #D81E76 0%, #FF9933 100%); border-radius: 10px; margin-bottom: -15px;"></div>
            </div>
            ...
            <div class="row justify-content-center g-4 mt-3">
                <div class="col-12 col-sm-8 col-md-5 col-lg-4" data-aos="flip-left" data-aos-delay="100">
                    <div class="bg-white asset-card-custom p-4 p-md-5 h-100 shadow-sm">
                        <img src="{{ asset('images/icon-guidebook.png') }}" alt="Guidebook" class="img-fluid mb-4" style="height: 90px;">
                        <h6 class="fw-bold text-dark mb-4">GUIDEBOOK<br>JKB FESTIVAL</h6>
                        <button class="btn text-white rounded-3 w-100 py-2 fw-semibold" style="background-color: #5b1456; font-size: 14px;">Download</button>
                    </div>
                </div>
                <div class="col-12 col-sm-8 col-md-5 col-lg-4" data-aos="flip-right" data-aos-delay="300">
                    <div class="bg-white asset-card-custom p-4 p-md-5 h-100 shadow-sm">
                        <img src="{{ asset('images/icon-logo-pack.png') }}" alt="Logo Pack" class="img-fluid mb-4" style="height: 90px;">
    ...
    <section id="timeline" class="py-5 text-center">
        <div class="container position-relative z-2 pb-4" data-aos="fade-up">
            ...
            <p class="text-muted small mt-4 px-3">Informasi tahapan dan waktu pelaksanaan kegiatan Lomba Web JKB Festival</p>
        </div>
                ...
                <div class="col-md-6 pe-md-5 timeline-col d-flex justify-content-end">
                    <div class="timeline-card-wrapper shadow-sm">
                        <div class="timeline-card-body">
                            ...
                            <p class="text-muted small mb-3">Tahap awal JKB Fest di mana calon peserta mendaftarkan diri sesuai persyaratan yang ditetapkan.</p>
                ...
                <div class="col-md-6 offset-md-6 ps-md-5 timeline-col d-flex justify-content-start">
                    <div class="timeline-card-wrapper shadow-sm">
                        <div class="timeline-card-body">
                            ...
                            <p class="text-muted small mb-3">Peserta yang telah mendaftar wajib mengumpulkan karya atau proyek sesuai tema JKB Fest.</p>
                ...
                <div class="col-md-6 pe-md-5 timeline-col d-flex justify-content-end">
                    <div class="timeline-card-wrapper shadow-sm">
                        <div class="timeline-card-body">
                            ...
                            <p class="text-muted small mb-3">Panitia dan dewan juri melakukan penilaian terhadap seluruh karya yang masuk.</p>
                ...
                <div class="col-md-6 offset-md-6 ps-md-5 timeline-col d-flex justify-content-start">
                    <div class="timeline-card-wrapper shadow-sm">
                        <div class="timeline-card-body">
                            ...
                            <p class="text-muted small mb-3">Hasil seleksi disampaikan kepada peserta melalui media resmi JKB Fest.</p>
                ...
                <div class="col-md-6 pe-md-5 timeline-col d-flex justify-content-end">
                    <div class="timeline-card-wrapper shadow-sm">
                        <div class="timeline-card-body">
                            ...
                            <p class="text-muted small mb-3">Penjelasan teknis pelaksanaan kegiatan bagi peserta yang lolos seleksi.</p>
                ...
                <div class="col-md-6 offset-md-6 ps-md-5 timeline-col d-flex justify-content-start">
                    <div class="timeline-card-wrapper shadow-sm">
                        <div class="timeline-card-body">
                            ...
                            <p class="text-muted small mb-3">Peserta mempresentasikan karya yang telah dibuat secara langsung di Politeknik.</p>
                ...
                <div class="col-md-6 pe-md-5 timeline-col d-flex justify-content-end">
                    <div class="timeline-card-wrapper shadow-sm">
                        <div class="timeline-card-body">
                            ...
                            <p class="text-muted small mb-3">Pengumuman pemenang serta pemberian penghargaan kepada peserta.</p>
    ...
    <section id="sponsor" class="text-center position-relative" style="padding-top: 15rem; padding-bottom: 15rem; margin-top: -40px; z-index: 3;">
        ...
        <div class="container position-relative z-2">
            <h2 class="fw-bolder text-white mb-5 d-inline-block pb-2" style="border-bottom: 3px solid #FF9933;" data-aos="fade-up">Sponsor By</h2>
            
            <div class="row justify-content-center g-3 mb-5">
                <div class="col-5 col-md-3 col-lg-2" data-aos="zoom-in" data-aos-delay="100">
                    <div class="rounded-4 d-flex align-items-center justify-content-center p-3 shadow" style="background: linear-gradient(135deg, #FFD1A9, #FFFFFF); height: 90px;"><i class="bi bi-gear-fill fs-2 text-secondary"></i></div>
                </div>
    ...
    <section id="faq" style="background-color: #FAFAFA; border-top-left-radius: 80px; border-top-right-radius: 80px; padding: 6rem 0; margin-top: -60px; position: relative; z-index: 4;">
        <div class="container px-4">
            <div class="text-center" data-aos="fade-up">
                <h2 class="fw-bolder text-dark mb-2">Pertanyaan Umum</h2>
                <p class="text-muted small mx-auto mb-4" style="max-width: 600px;">Informasi dan jawaban atas pertanyaan umum mengenai JKB Fest disajikan di halaman ini.</p>
                <div class="mx-auto mb-5" style="width: 80px; height: 4px; background: linear-gradient(135deg, #D81E76 0%, #FF9933 100%); border-radius: 5px;"></div>
            </div>
