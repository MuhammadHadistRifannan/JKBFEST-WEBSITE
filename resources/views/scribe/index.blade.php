...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-user-login">LOGIN USER</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^(?=.<em>[a-z])(?=.</em>[A-Z])(?=.<em>\d)(?=.</em>[@$!%*?&amp;]).+$/. Must be at least 8 characters. Example: <code>Z5ij-e/dl4m{o,</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-user">REGISTER USER.</h2>
...
<div class="bash-example">
    ...
    \"no_telp\": \"hfqcoynlazghdtqtqxbajwbpilpmufinllwloauydlsmsjuryvojcybzvrbyickznkygloigmkw\",
    \"password\": \"Z&lt;Ip!{D_)R4\'\\\"[{sku;\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="nama"                data-endpoint="POSTapi-user"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="no_telp"                data-endpoint="POSTapi-user"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Z<Ip!{D_)R4'"[{sku;"
               data-component="body">
    <br>
<p>Must match the regex /^(?=.<em>[a-z])(?=.</em>[A-Z])(?=.<em>\d)(?=.</em>[@$!%*?&amp;]).+$/. Must be at least 8 characters. Example: <code>Z&lt;Ip!{D_)R4'"[{sku;</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-user--id-">GET USER BY ID</h2>
...
<p>The ID of the user. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-user--id-">UPDATE USER BY ID</h2>
...
<p>The ID of the user. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-user--id-">DELETE USER BY ID</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/team/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/team/consequatur"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-team--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the team. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-team--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the team. Example: <code>consequatur</code></p>
