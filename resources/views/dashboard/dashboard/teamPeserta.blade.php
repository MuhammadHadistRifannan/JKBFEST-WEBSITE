        ...
        <div class="ms-3 position-relative z-1">
            <div class="d-flex align-items-center gap-2">
                ...
                @if ($user->team)
                    ...
                    @elseif ($user->team->document_path)
                        <span
            ...
            <h4 class="fw-bold mb-0 mt-0 mt-lg-2">{{ $user->team->name ?? 'Langsung di ACC Saja' }}</h4>
        </div>
    ...
    <div class="row g-4">
            ...
            <div class="card p-4 rounded-4 shadow-sm h-100">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="text-custom-purple fw-bold d-flex align-items-center gap-2 mb-0 text-dark">
                        <img src="{{ asset('icons/dashboard/people.svg') }}" alt="Team Icon" class="icon-svg"> Informasi
                        Team
                    </h5>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="bg-soft-pink p-3 rounded-3">
                            <small class="text-muted d-block mb-1"><i class="bi bi-building me-1"></i> Asal
                                Institusi</small>
                            <span
                                class="fw-medium text-dark">{{ $user->team->institution ?? 'Politeknik Negeri Cilacap' }}</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="bg-soft-pink p-3 rounded-3">
                            <small class="text-muted d-block mb-1"><i class="bi bi-person-badge me-1"></i> Nama
                                Pembina</small>
                            <span
                                class="fw-medium text-dark">{{ $user->team->advisor_name ?? 'Severus Snape S.kom' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex flex-column gap-3">
                    <div
                        ...
                        <div>
                            <h6 class="fw-medium mb-1">{{ $user->name ?? 'Harry Potter' }}</h6>
                            <small class="text-muted">{{ $user->phone ?? '086445678998745' }}</small>
                        </div>
                    ...
                    <div class="border border-secondary rounded-3 p-3">
                        <h6 class="fw-medium mb-1">Hermione Granger</h6>
                        <small class="text-muted">086445678998745</small>
                    </div>

                    <div class="border border-secondary rounded-3 p-3">
                        <h6 class="fw-medium mb-1">Ron Weasley</h6>
                        <small class="text-muted">086445678998745</small>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card p-4 rounded-4 shadow-sm mb-4">
                ...
                @if ($user->team && $user->team->is_verified)
                ...
                @else
                    ...
                    @if ($user->team && $user->team->document_path)
                    ...
                    <div class="bg-soft-pink border border-secondary p-3 rounded-3 d-flex align-items-center gap-3">
                        ...
                        <div class="overflow-hidden">
                            <h6 class="mb-0 fw-normal">
                                {{ $user->team->name ?? 'Langsung di Acc Saja' }}_Web jkb fest.pdf
                            </h6>
                        </div>
                    </div>
                @else
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3 p-3 rounded-3">
                            ...
                            <div>
                                <small class="fw-light d-block" style="font-size: 11px;">Nama Team
                                    :</small>
                                <span
                                    class="fw-bold text-custom-purple">{{ $user->team->name ?? 'Langsung di ACC Saja' }}</span>
                            </div>
                        </div>
