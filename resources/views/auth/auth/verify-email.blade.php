                ...
                <div class="register-card border-custom position-relative">
                    ...
                    <div class="padding-custom pt-4 text-center">
                        ...
                        <div class="envelope-icon-wrapper">
                            {{-- Gunakan ikon amplop SVG atau gambar dari folder Anda. Jika belum ada asset, ini menggunakan
                            ikon Bootstrap --}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="#FF49C1"
                                class="bi bi-envelope-fill envelope-icon" viewBox="0 0 16 16">
                                <path
                        ...
                        <p class="text-dark mb-4 mx-auto" style="font-size: 14px; max-width: 320px;">
                            Masukkan 6-digit kode verifikasi yang dikirim ke email <span class="fw-bold">{{ $data['email'] ?? ''}}</span>
                        </p>
                        ...
                        <form method="post" action={{ route('verify_email') }}>
                            ...
                            <input type="hidden" name="no_telepon" value="{{ $data['no_telepon'] ?? '' }}">
                            <input type="hidden" name="password" value="{{ $data['password'] ?? '' }}">


                            <div class="otp-wrapper">
                                <input type="text" class="otp-input" maxlength="1" name="otp[]" id="otp1" autocomplete="off"
                                    autofocus>
                                ...
                                <input type="text" class="otp-input" maxlength="1" name="otp[]" id="otp4"
                                    autocomplete="off">
                                <input type="text" class="otp-input" maxlength="1" name="otp[]" id="otp5"
                                    autocomplete="off">
                                <input type="text" class="otp-input" maxlength="1" name="otp[]" id="otp6"
                                    autocomplete="off">
                            </div>

                            <button type="submit" class="btn btn-register btn-gradient-custom w-100 py-2 shadow-sm mb-3"
