...
<head>
    ...
    <title>Kode Verifikasi OTP - JKB Festival</title>
    <style>
    ...
    <tr>
        <td align="center" style="padding: 40px 10px 40px 10px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
                ...
                <tr>
                    <td align="center" style="padding: 20px 40px 10px 40px; color: #333333; font-size: 16px; line-height: 24px; text-align: center;">
                        <h2 style="margin: 0 0 15px 0; font-size: 22px; color: #222222;">Verifikasi Akun Anda</h2>
                        <p style="margin: 0 0 10px 0;">
                            Halo,<br>
                            Gunakan kode OTP (One-Time Password) di bawah ini untuk memverifikasi akun JKB Festival Anda. Kode ini hanya berlaku selama <strong>5 menit</strong>.
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" style="padding: 10px 40px 20px 40px;">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                                <td align="center">
                                    <div style="background-color: #f9f0f6; border: 1px dashed #b71c77; border-radius: 8px; padding: 20px; display: inline-block;">
                                        <span style="font-size: 36px; font-weight: bold; letter-spacing: 8px; color: #411041; font-family: 'Courier New', Courier, monospace;">
                                            {{$otp}}
                                        </span>
                                    </div>
                                </td>
                ...
                <tr>
                    <td align="center" style="padding: 10px 40px 40px 40px; color: #666666; font-size: 14px; line-height: 20px;">
                        <p style="margin: 0; color: #d32f2f; font-weight: bold;">
                            PENTING: Jangan berikan kode OTP ini kepada siapapun, termasuk pihak JKB Festival.
                        </p>
                        <br>
                        <p style="margin: 0;">
                            Jika Anda tidak merasa mendaftar atau melakukan permintaan ini, silakan abaikan email ini.
                        </p>
                    </td>
                </tr>
