        ...
        <div class="table-responsive">
            <table class="table-karya">
                ...
                <tbody>
                    <tr>
                        <td>
                            <h6 class="fw-bold text-dark mb-1" style="font-size: 14px;">Langsung di ACC Saja</h6>
                            <small class="text-muted" style="font-size: 11px;">Kategori : Web Development</small>
                        </td>
                        <td>
                            <a href="#" class="drive-link">
                        ...
                        <td class="fw-medium">25 April 2026, 20:00 WIB</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="fw-medium">25 April 2026, 20:00 WIB</td>
                        <td>
                            <div class="badge-status bg-terlambat">Telambat</div>
                        </td>
                        <td>
                            <button class="btn-nilai">Nilai</button>
                        </td>
