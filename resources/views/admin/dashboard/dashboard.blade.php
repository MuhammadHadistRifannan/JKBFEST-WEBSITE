...
@section('styles')
    <style>
        ...
        .pie-chart {
            ...
            height: 70px;
            border-radius: 50%;
            background: conic-gradient(#FF49C1 0deg 120deg,
...
@section('content')
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div
                class="hero-gradient-admin card text-white p-4 p-md-5 mb-4 rounded-4 border-0 shadow-sm position-relative overflow-hidden">
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 rounded-4 shadow-sm p-4 mb-4">
                ...
                <div class="timeline-container">
                    <div class="timeline-item" data-start="2026-04-03" data-end="2026-04-26" data-name="Pendaftaran"
                        data-date-text="26 April 2026">
                        <div class="timeline-dot"></div>
                        <div class="timeline-card">
                            <h6 class="fw-bold text-dark mb-1">Pendaftaran</h6>
                            <small class="text-muted">3 April - 26 April 2026</small>
                        </div>
                    </div>

                    <div class="timeline-item" data-start="2026-04-03" data-end="2026-05-02" data-name="Pengumpulan"
                        data-date-text="2 Mei 2026">
                        <div class="timeline-dot"></div>
                        <div class="timeline-card">
                    ...
                    <div class="timeline-item" data-start="2026-05-03" data-end="2026-05-14" data-name="Seleksi"
                        data-date-text="14 Mei 2026">
                        <div class="timeline-dot"></div>
                        <div class="timeline-card">
                    ...
                    <div class="timeline-item" data-start="2026-05-15" data-end="2026-05-15" data-name="Pengumuman"
                        data-date-text="15 Mei 2026">
                        <div class="timeline-dot"></div>
                        <div class="timeline-card">
                    ...
                    <div class="timeline-item" data-start="2026-05-16" data-end="2026-05-16" data-name="Teknikal Meeting"
                        data-date-text="16 Mei 2026">
                        <div class="timeline-dot"></div>
                        <div class="timeline-card">
                    ...
                    <div class="timeline-item extra-timeline d-none" data-start="2026-05-22" data-end="2026-05-22"
                        data-name="Final Project" data-date-text="22 Mei 2026">
                        <div class="timeline-dot"></div>
                        <div class="timeline-card">
                    ...
                    <div class="timeline-item extra-timeline d-none" data-start="2026-05-23" data-end="2026-05-23"
                        data-name="Awarding" data-date-text="23 Mei 2026">
                        <div class="timeline-dot"></div>
                        <div class="timeline-card">
                ...
                <div class="mt-3">
                    <a href="#" id="toggleTimelineBtn" class="text-decoration-none text-primary fw-medium"
                        style="font-size: 13px;">Selanjutnya ></a>
                </div>
            </div>
            ...
            <div class="card border-0 rounded-4 shadow-sm p-4">
                ...
                <div class="bg-soft-pink rounded-3 p-3 mb-3 border border-light">
                    <h6 class="fw-bold text-custom-purple mb-1" id="ongoingTitle">Menunggu Event</h6>
                    <small class="text-muted fw-medium" style="font-size: 12px;" id="ongoingDate">Ditutup : -</small>
                </div>

                <div class="countdown-gradient rounded-3 p-4 text-white d-flex align-items-center gap-3">
                    <i class="bi bi-clock fs-1"></i>
                    <div>
                        <h4 class="fw-bold mb-0" id="ongoingCountdown">- Hari Lagi</h4>
                        <small class="fw-light" style="font-size: 12px;" id="ongoingLabel">Menuju Tahap Selanjutnya</small>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // (Opsional) Hapus tanda '//' di bawah ini untuk simulasi/testing tanggal tertentu
    ...
    timelineItems.forEach(item => {
        // Ambil range tanggal dari atribut HTML, set waktu ke awal dan akhir hari
        ...
        // 2. Reset semua state menjadi tidak aktif terlebih dahulu
        dot.classList.remove('active');
        card.classList.remove('active');
        titleElement.classList.remove('text-custom-purple');
        titleElement.classList.add('text-dark');

        // 3. Cek apakah tanggal hari ini masuk dalam range tahap ini
        // (Gunakan !activeFound agar jika ada tanggal yg tumpang tindih, prioritas ke tahap yang paling atas)
        if (!activeFound && now >= start && now <= end) {
            activeFound = true; 
            
            // Set elemen ini menjadi aktif
            dot.classList.add('active');
            card.classList.add('active');
            titleElement.classList.remove('text-dark');
            titleElement.classList.add('text-custom-purple');

            // 4. Update widget "Sedang Berlangsung"
            const name = item.dataset.name;
            const dateText = item.dataset.dateText;
            
            document.getElementById('ongoingTitle').textContent = name;
            document.getElementById('ongoingDate').textContent = 'Ditutup : ' + dateText;
            document.getElementById('ongoingLabel').textContent = 'Menuju Penutupan ' + name;

            // 5. Hitung sisa hari untuk Countdown
            const diffTime = end - now;
            const diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24)); // Konversi milidetik ke hari
            
            const countdownEl = document.getElementById('ongoingCountdown');
            if (diffDays > 0) {
                countdownEl.textContent = diffDays + ' Hari Lagi';
            } else if (diffDays === 0) {
                countdownEl.textContent = 'Hari Ini Terakhir!';
            }
        }
    });

    // 6. Penanganan jika belum mulai atau event sudah sepenuhnya selesai
    if (!activeFound) {
        document.getElementById('ongoingTitle').textContent = 'Tidak Ada / Selesai';
        document.getElementById('ongoingDate').textContent = '-';
        document.getElementById('ongoingCountdown').textContent = '0 Hari';
        document.getElementById('ongoingLabel').textContent = 'Event sedang tidak berlangsung';
    }
});
</script>
@endsection